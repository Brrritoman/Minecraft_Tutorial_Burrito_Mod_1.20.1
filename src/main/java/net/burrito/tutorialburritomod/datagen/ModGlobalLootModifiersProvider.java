...
import net.burrito.tutorialburritomod.loot.AddItemModifier;
import net.burrito.tutorialburritomod.loot.AddSusSandItemModifier;
...
public class ModGlobalLootModifiersProvider extends GlobalLootModifierProvider {
    public ModGlobalLootModifiersProvider(PackOutput output) {
        super(output, TutorialBurritoMod.MOD_ID);
    }
